namespace NServiceBus.Transport.Kafka.Receiving
{
    ...
    class MessageConverter
    {
        ...
        public MessageConverter(Func<Message, string> messageIdStrategy)
        {
            this.messageIdStrategy = messageIdStrategy;
        }

        public string RetrieveMessageId(Message message, Dictionary<string, string> headers)
        {
        ...
        public Dictionary<string, string> RetrieveHeaders(Message message)
        {
        ...
        string DefaultMessageIdStrategy(Message message)
        {
            var properties = message.BasicProperties;
        ...
        readonly Func<Message, string> messageIdStrategy;
